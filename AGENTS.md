...
11. **Phase 13 IN PROGRESS (2026-07-06):** Validator — post-collection data editing & validation. Full design in `docs/validator-plan.md`.
   ...
   - NOT DONE: hub UI (flag queue, record/triage view, rule editor, annotations), Supabase/local-API persistence for runs/flags/dispositions/rules/corrections/suppressions, reference-dataset confrontation (V2), tacit-knowledge ratchet / LLM assistance (V3). See `docs/validator-plan.md` §11 for phasing — do not report the Validator as complete until the hub UI + persistence land.
